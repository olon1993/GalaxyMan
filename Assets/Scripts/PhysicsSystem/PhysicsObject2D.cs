...
namespace TheFrozenBanana
{
    public class PhysicsObject2D : RaycastController
    {
        ...
        protected virtual void CalculateVelocity()
        {
            ...
            float targetVelocityY = VerticalMovement;
            ...
            {
                _velocity.y = Mathf.SmoothDamp(_velocity.y, targetVelocityY, ref _velocityXSmoothing, _collisions.Below ? _smoothTimeGrounded : _smoothTimeAirborne);
            }
        }
